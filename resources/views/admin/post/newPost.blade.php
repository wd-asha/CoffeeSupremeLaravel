        ...
        <form action="{{ route('admin.post.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-layout">
                <div class="row mg-b-25">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_title" placeholder="Input name"><br>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="summernote" name="post_content"></textarea><br>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <label class="custom-file">
                                <input class="custom-file-input" type="file" id="file" name="post_image" data-placeholder="Select image" onchange="readURL1(this);" required><br><br>
                                <span class="custom-file-control"></span>
                                <img src="{{ asset('media/post/empty-image.png') }}" id="one">
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-layout-footer">
                    ...
                    <a href="{{ route('admin.post') }}" class="btn btn-secondary">Cancel</a>
                </div>
            </div>
        </form>
