...
@section('content')
    <div class="card pd-20 pd-sm-40 mg-t-50">
        ...
        <p class="mg-b-20 mg-sm-b-30">Total categories: {{ $categories->total() }}<span style="float: right">
            <a href="" class="btn btn-info" data-toggle="modal" data-target="#modaldemo3">New category</a>
        </span></p>
            ...
            <table class="table table-hover table-bordered mg-b-0 mb-5">
                ...
                @foreach($categories as $category)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.category.delete', $category->id) }}" id="delete" class="btn btn-outline-danger">Delete</a>
                        </td>
                    </tr>
                @endforeach
