...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/latest-posts.css')}}">
    <link rel="stylesheet" href="{{asset('css/wholesale-main.css')}}">
    <link rel="stylesheet" href="{{asset('css/cart.css')}}">
    <link rel="stylesheet" href="{{asset('css/up-footer.css')}}">
...
<div class="header-bg">
    ...
    <header class="header" id="header">
        ...
        {{-- Side Menu Block -> Equipment Panel --}}
        <div class="equipment-panel" id="equipmentPanel">
            <div class="equipment-panel_item">
               ...
               @foreach($subcategories as $subcategory)
                   @if($subcategory->title === "Filter Machines")
                        <a href="{{ route('shop.equipments') }}#filtermash">{{ $subcategory->title }}</a>
                   @elseif($subcategory->title === "Espresso Machines")
                        <a href="{{ route('shop.equipments') }}#espmash">{{ $subcategory->title }}</a>
                   @elseif($subcategory->title === "Grinders")
                        <a href="{{ route('shop.equipments') }}#grinder">{{ $subcategory->title }}</a>
                   @elseif($subcategory->title === "Accessories")
                        <a href="{{ route('shop.equipments') }}#access">{{ $subcategory->title }}</a>
                   @elseif ($subcategory->title === "KeepCups")
                        <a href="{{ route('shop.equipments') }}#cups">{{ $subcategory->title }}</a>
                   @else
                       <a href="{{ route('shop.equipments') }}#papers">{{ $subcategory->title }}</a>
                   @endif
                @endforeach
            </div>
        </div>
        {{-- end side menu block -> equipment panel --}}
        {{-- Side Menu Block -> Coffees Panel --}}
        ...
        {{-- end side menu block -> coffees panel --}}
    </header>
</div>
{{-- end side menu block --}}
