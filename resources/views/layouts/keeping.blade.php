...
<script>
    let splidePaginationPages = document.querySelectorAll('.splide__pagination__page');
    let count = 1;
    let slideTexts = document.querySelectorAll('.slide__text');

    function showText() {
        slideTexts.forEach(function (e) {
    ...
    splidePaginationPages.forEach(function (e) {
        switch(count) {
            case 1:
                e.classList.add('count1');
                count = 2;
                break;
            case 2:
                e.classList.add('count2');
                count = 3;
                break;
            case 3:
                e.classList.add('count3');
                count = 4;
                break;
            case 4:
                e.classList.add('count4');
                count = 5;
                break;
            case 5:
                e.classList.add('count5');
                count = 6;
                break;
            case 6:
                e.classList.add('count6');
                count = 7;
                break;
            case 7:
                e.classList.add('count7');
                count = 8;
                break;
            case 8:
                e.classList.add('count8');
                count = 9;
                break;
            case 9:
                e.classList.add('count9');
                count = 10;
                break;
            case 10:
                e.classList.add('count10');
                count = 1;
                break;
            default:
        }
